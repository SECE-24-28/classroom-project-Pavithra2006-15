...
<button className="button2">Join Live Demo</button>
       ...
       <div className="container4">
        ...
        <p>With our continuous research and development, we provide you with an excellent Aptitude training.</p>
       </div>
       ...
       <div className="container6">
        <div className="box">
          <div className="box-up"> <img src="/image1.png" alt="1img" /></div>
          <div className="box-bottom">
             <h2>⭐⭐⭐⭐⭐  5</h2>
            <h3>Aptitude Complete Preparation</h3>
            <p>Recommended: Final year students</p>
            <p>Duration: 1 year</p>
<h1>₹12,000 </h1>
<div className="box-button">
  ...
  <button className="b2">Know More</button>
         ...
         <div className="box">
          <div className="box-up"> <img src="/image2.png" alt="2img" /></div>
          <div className="box-bottom">
            <h2>⭐⭐⭐⭐  4</h2>
            <h3>Technical Complete Peparation</h3>
            <p>Recommended: Final year students</p>
            <p>Duration: 1 year</p>
<h1>₹12,000 </h1>
<div className="box-button">
  ...
  <button className="b2">Know More</button>
         ...
         <div className="box">
          <div className="box-up"> <img src="/image3.png" alt="3img" /></div>
          <div className="box-bottom">
             <h2>⭐⭐⭐  3</h2>
            <h3>Technical Complete Peparation</h3>
            <p>Recommended: Final year students</p>
...
<div className="box-button">
  ...
  <button className="b2">Know More</button>
    ...
    <div className="container6-viewmore">
         <h1>View More →</h1>
    </div>
    ...
    <div className="container8">
      <div className="left">
        ...
        <p>Send us a message and we will respond soon</p>
